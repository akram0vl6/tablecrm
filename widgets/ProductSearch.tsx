...
export function ProductSearch({ isConnected, searchProduct, onSearch, isSearching, foundProducts, productSearchOpen, onToggleSearch, onAddToCart }: ProductSearchProps) {
  return (
      ...
      <CardContent className="pt-5 space-y-3">
        ...
        <div className="relative">
          ...
          <Input
            ...
            className="pl-10 transition-all duration-200 focus:ring-2 focus:ring-indigo-400"
            value={searchProduct}
            onChange={(e) => onSearch(e.target.value)}
            disabled={!isConnected}
            onFocus={() => foundProducts.length > 0 && onToggleSearch(true)}
